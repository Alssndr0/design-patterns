...
is ever loaded. No matter how many times the SentimentAnalyzer class is instantiated, the heavy pipeline is only initialized once,
...
if __name__ == "__main__":
    ...
    result1 = analyzer1.analyze("I love using this product! It's amazing.")
    ...
    result2 = analyzer2.analyze("I am very disappointed and sad.")
